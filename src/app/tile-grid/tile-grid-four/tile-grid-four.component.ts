...
@Component({
  selector: 'app-tile-grid-four',
  templateUrl: './tile-grid-four.component.html',
  styleUrls: ['./tile-grid-four.component.css']
})
export class TileGridFourComponent implements OnInit {
